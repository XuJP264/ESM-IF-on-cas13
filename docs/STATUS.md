...
| M3 Atlas | official download in progress | official 5,267,508,328-byte source HEAD/schema verified; initial DNS failure preserved; resumable `.part` is growing; 100k-record production schema diagnostic found and fixed generic-`VI` subtype undercount with raw/source/conflict audit |
