...
| M2 experimental benchmark | ESM pilot and required CPU smokes complete; fair matrix implementation ready | four RCSB structures downloaded/QC; clean 72-candidate ESM-IF1 pilot has unique IDs and zero fixed violations; genuine 6E9F/5XWP ProteinMPNN and RNA-context LigandMPNN smokes plus protein/soluble checkpoint smokes pass; formal small matched run remains |
...
- pytest: 59/59 pass;
- branch-aware coverage: 72.03% (required 70%);
