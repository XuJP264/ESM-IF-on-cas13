...
| M6 migration/refold | source interfaces/guide verified; target pending | provider-neutral mock E2E and migration scripts exist; pre-Atlas clean bundle passed; a new Atlas-complete bundle must be exported this phase; target transfer/bootstrap/GPU/refold remain |
